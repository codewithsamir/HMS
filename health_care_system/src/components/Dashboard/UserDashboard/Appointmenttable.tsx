          ...
          <TableBody className="bg-white divide-y divide-gray-200">
            {appointments.map((appointment, index) => (
              <TableRow key={appointment.id} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                ...
                <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{appointment.doctor}</TableCell>
                <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{appointment.date}</TableCell>
