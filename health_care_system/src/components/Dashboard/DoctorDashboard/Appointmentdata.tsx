...
import { DoctorAppointment } from '@/store/Appointment';
import ActionAppointment from '../actionAppointment'; // Import the updated popup component
...
const Appointmentdata = ({ appointments, onEdit }: AppointmentsTableProps) => {
